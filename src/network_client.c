/*
 * original code: https://github.com/abysamross/simple-linux-kernel-tcp-client-server
 */
...
unsigned char DESTIP[5];
unsigned int DESTPORT;
char MSG_FROM_SERVER[4096];
...
read_again:
        ...
        strncpy(MSG_FROM_SERVER, str, sizeof(MSG_FROM_SERVER));
        //set_fs(oldmm);
        return len;
}
...
int tcp_client_connect(void)
{
        ...
        */
        ...
        /*
         * "destip" was declarated as s gloval bariable
         */
